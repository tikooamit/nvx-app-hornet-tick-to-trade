...
final public class EMSNewOrderSinglePopulator {
    final public static EMSNewOrderSingle populate(final EMSNewOrderSingle message, XString orderId, final Random random) {
        ...
        message.setOrderQty(5000);// Only populated in X
