...
final public class Constants {
    ...
    final public static XString PUMA_SIMULATOR = XString.create("puma-simulator", false, true);
    ...
    final public static XString PUBLISHING_SYSTEM = XString.create("TBBTEMSTZTNYK", false, true);
    ...
    final public static XString BROKER = XString.create("BCSL", false, true);
    final public static XString TARGET_COMPID = XString.create("BBEMSZTNYK", false, true);
