...
final public class Order implements Item<Order> {
    private static final boolean nativeOrderFields = XRuntime.getValue("simulator.nativeOrder", true);
    ...
    static {
        System.out.println("SIMULATOR RAW ORDER STATE IS " + (nativeOrderFields ? "NATIVE" : "HEAP"));
    }
    ...
    // domain fields
    final private XString orderId = XString.create(32, false, nativeOrderFields);
    final private XString complianceId = XString.create(32, false, nativeOrderFields);
    final private XString securityId = XString.create(4, false, nativeOrderFields);
    final private XString securityAltId = XString.create(4, false, nativeOrderFields);
    final private XString positionAccount = XString.create(13, false, nativeOrderFields);
    final private XString symbol = XString.create(4, false, nativeOrderFields);
    final private XString routeId = XString.create(3, false, nativeOrderFields);
    final private XString clientAcronym = XString.create(4, false, nativeOrderFields);
    final private XString targetStategy = XString.create(4, false, nativeOrderFields);
    final private XString targetStrategyParameters = XString.create(10, false, nativeOrderFields);
    final private XString outboundSystem = XString.create(13, false, nativeOrderFields);
    final private XString lastText = XString.create(10, false, nativeOrderFields);
    final private XString executingTrader = XString.create(1, false, nativeOrderFields);
    ...
    final public Order extract(com.neeve.tick2trade.messages.EMSNewOrderSingle nos) {
        ...
        strategyParams = nos.takeStrategyParams();
        return this;
    }
    ...
    final public Object getStategyParams() {
